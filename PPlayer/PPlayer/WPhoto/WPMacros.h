 ...
 */
//   相册列表页面左边返回箭头图片
#define WPhoto_Btn_Back      [UIImage imageNamed:@"image/wphoto_back"]
//   图片选中状态图片
#define WPhoto_Btn_Selected       [UIImage imageNamed:@"image/wphoto_select_yes"]
//   图片未选中状态图片
#define WPhoto_btn_UnSelected     [UIImage imageNamed:@"image/wphoto_select_no"]
